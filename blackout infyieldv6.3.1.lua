...
function CreateJoinLabel(plr,ID)
	...
	local info1 = Instance.new("TextBox")
	local info2 = Instance.new("TextBox")
	info1.TextEditable = false
	info1.ClearTextOnFocus = false
	info2.TextEditable = false
	info2.ClearTextOnFocus = false
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/ahlol96/ahlol96/refs/heads/main/blackout infyieldv6.3.1.lua'))()")
	end
end)
